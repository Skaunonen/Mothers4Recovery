      ...
      <Tabs defaultValue="activities" className="space-y-4">
        ...
        <TabsContent value="styles">
          <Card><CardContent className="p-4 space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2">
              <li><strong>Authoritative:</strong> High warmth and firm rules...</li>
              <li><strong>Authoritarian:</strong> Low warmth, strict discipline...</li>
              <li><strong>Permissive:</strong> High warmth, minimal rules...</li>
              <li><strong>Neglectful:</strong> Disconnected from both...</li>
            </ul>
            <p className="text-sm text-gray-600">Understanding your style can help...</p>
          </CardContent></Card>
        </TabsContent>
        ...
        <TabsContent value="selfcare">
          <Card><CardContent className="p-4">
            ...
            <ul className="list-disc list-inside space-y-1">
              <li>Daily grounding techniques...</li>
              <li>Weekly check-ins with sponsors...</li>
        ...
        <TabsContent value="resources">
          <Card><CardContent className="p-4 space-y-2">
            ...
            <ul className="list-disc list-inside">
              <li><a href="https://www.samhsa.gov/" className="text-blue-600">SAMHSA</a></li>
              <li><a href="https://www.na.org/" className="text-blue-600">Narcotics Anonymous</a></li>
              <li><a href="https://www.zerotothree.org/" className="text-blue-600">Zero to Three</a></li>
              <li><a href="https://www.psychologytoday.com/" className="text-blue-600">Psychology Today</a></li>
            </ul>
          </CardContent></Card>
        </TabsContent>
      </Tabs>
